...
void R_RSPI0_Create(void)
{
    ...
    RSPI0.SPCMD0.WORD = _0001_RSPI_RSPCK_SAMPLING_EVEN | _0002_RSPI_RSPCK_POLARITY_HIGH | _0000_RSPI_BASE_BITRATE_1 | 
                        _0000_RSPI_SIGNAL_ASSERT_SSL0 | _0000_RSPI_SSL_KEEP_DISABLE | _0100_RSPI_DATA_LENGTH_BITS_24 | 
...
*                    buffer size
*                rx_buf -
*                    receive buffer pointer (not used when data is handled by DTC/DMAC)
* Return Value : status -
