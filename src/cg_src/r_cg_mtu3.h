...
#define _05_MTU_PCLK_256                (0x05U) /* Internal clock: counts on PCLK/256 (for MTU3,4,6,7,8 only) */
...
#define _04_MTU_PCLK_1024               (0x04U) /* Internal clock: counts on PCLK/1024 (for MTU1 only) */
...
#define _00_MTU_I1AE_DISABLE            (0x00U) /* Does not include MTIOC1A pin in MTU3.TGRA input capture condition */
#define _01_MTU_I1AE_ENABLE             (0x01U) /* Includes MTIOC1A pin in MTU3.TGRA input capture condition */
/* Input Capture Enable (I1BE) */
#define _00_MTU_I1BE_DISABLE            (0x00U) /* Does not include TMTIOC1B pin in MTU3.TGRB input capture condition */
#define _02_MTU_I1BE_ENABLE             (0x02U) /* Includes MTIOC1B pin in MTU3.TGRB input capture condition */
...
#define _0000_MTU_DT4BE_DISABLE         (0x0000U) /* A/D converter start request disabled during MTU4.TCNT down-count */
#define _0010_MTU_DT4BE_ENABLE          (0x0010U) /* A/D converter start request enabled during MTU4.TCNT down-count */
/* Up-Count TRG4BN Enable (UT4BE) */
#define _0000_MTU_UT4BE_DISABLE         (0x0000U) /* A/D converter start requests disabled during MTU4.TCNT up-count */
#define _0020_MTU_UT4BE_ENABLE          (0x0020U) /* A/D converter start requests enabled during MTU4.TCNT up-count */
/* Down-Count TRG4AN Enable (DT4AE) */
#define _0000_MTU_DT4AE_DISABLE         (0x0000U) /* A/D converter start request disabled during MTU4.TCNT down-count */
#define _0040_MTU_DT4AE_ENABLE          (0x0040U) /* A/D converter start request enabled during MTU4.TCNT down-count */
/* Up-Count TRG4AN Enable (UT4AE) */
#define _0000_MTU_UT4AE_DISABLE         (0x0000U) /* A/D converter start requests disabled during MTU4.TCNT up-count */
#define _0080_MTU_UT4AE_ENABLE          (0x0080U) /* A/D converter start requests enabled during MTU4.TCNT up-count */
...
*/
#define _00_MTU6_SYNC_OFF               (0x00U) /* Disables counter synchronous clearing */
...
***********************************************************************************************************************/
/* PWM1 TGRA value */
#define _7530_TGRA_VALUE                (0x7530U)
/* PWM1 TGRB value */
...
/* PWM1 TGRE value */
#define _0064_TGRE_VALUE                (0x0064U)
/* PWM1 TGRF value */
#define _0064_TGRF_VALUE                (0x0064U)
/* Set TGRA value */
#define _0063_TGRA_VALUE                (0x0063U)
/* Set TGRB value */
...
#define _0064_TGRC_VALUE                (0x0064U)
/* PWM1 TGRD value */
#define _0257_TGRD_VALUE                (0x0257U)
/* PWM1 TGRA value */
#define _0064_TGRA_VALUE                (0x0064U)
/* PWM1 TGRB value */
