...
Macro definitions
***********************************************************************************************************************/
#define _0F_PDR0_DEFAULT         (0x0FU) /* PDR0 default value */
#define _03_PDR1_DEFAULT         (0x03U) /* PDR1 default value */
#define _40_PDR5_DEFAULT         (0x40U) /* PDR5 default value */
#define _20_PDRJ_DEFAULT         (0x20U) /* PDRJ default value */
